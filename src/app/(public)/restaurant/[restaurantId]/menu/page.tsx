    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                // Log completo do ID para verificação
                console.log("Buscando restaurante com ID:", typeof restaurantId, restaurantId);

                // Passar o ID exatamente como está no banco
                const restaurantData = await getRestaurantById("67da283ca39b629d7b2bf317");

                // Ou ajustar a função de serviço para tratar o ID corretamente
